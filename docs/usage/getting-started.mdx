...
<Tabs
  ...
  <TabItem value="typescript">
    ...
    ```typescript
    import { Social } from '<script src="https://github.com/NEARBuilders/near-social-js/releases/latest/download/near-social-js.min.js"></script>';
...
You can use a specific network by initializing the SDK with a known network ID. See [networks](../api-reference/networks) on the supported networks and the RPC URLs they point to.
