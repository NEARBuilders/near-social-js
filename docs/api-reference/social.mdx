...
| Name    | Type                                                         | Required | Default | Description                                                                                          |
|---------|--------------------------------------------------------------|----------|---------|------------------------------------------------------------------------------------------------------|
| options | [`IStorageBalanceOfOptions`](types#istoragebalanceofoptions) | yes      | -       | Options that include the account ID to check and a signer account to use to check read the contract. |

#### Returns

| Type                                                                        | Description                                                                                                |
|-----------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| [`Promise<IStorageBalanceOfResult \| null>`](types#istoragebalanceofresult) | A promise that resolves the total and available balance or null if the account ID does not have a balance. |
