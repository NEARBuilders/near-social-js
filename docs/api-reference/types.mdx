...
| publicKey           | [`PublicKey`](https://near.github.io/near-api-js/classes/near_api_js.utils.PublicKey.html) | yes      | -       | The signer account's public key for the access key that will be used to write to the contract. The key must have write access for the account. For details on managing keys see the NEAR API [docs](https://docs.near.org/tools/near-api-js/account#access-keys).                                            |
