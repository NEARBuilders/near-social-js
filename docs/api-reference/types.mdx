...
| Name      | Type                                                                                     | Required | Default | Description                                                                                                                                             |
|-----------|------------------------------------------------------------------------------------------|----------|---------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| accountId | `string`  																				                                                           | yes  			 | -       | The account ID for which to check the balance of.                                                                                                       |
...
| Name      | Type                 | Required | Default | Description                               |
|-----------|----------------------|----------|---------|-------------------------------------------|
| available | `string`  										 | yes  		  | -       | The yotoNEAR amount of deposit available. |
| total     | `string`             | yes      | -       | The total yotoNEAR amount deposited.      |

### `IStorageDepositResult`
