...
export const Route = createRootRouteWithContext<RouterContext>()({
	...
	head: ({ loaderData }) => {
		...
		const title = "NearSocial.JS Demo";
		const description =
			"Interactive demo for NearSocial.JS with Graph and Social methods powered by Module Federation and SSR.";
		const siteName = "NearSocial.JS";
