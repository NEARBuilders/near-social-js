...
export function ResponsePanel({
  ...
  const maxHeightClass = variant === 'fixed'
    ? 'max-h-[70vh]'
    : 'max-h-[600px]'

  return (
    <div className={`rounded-xl bg-gray-900 border border-white/10 overflow-hidden shadow-2xl pointer-events-auto ${className}`}>
      <button
