...
const GradientBlur = ({
  ...
  className: string
  opacity?: string
}) => <div className={`absolute blur-[60px] pointer-events-none ${opacity} ${className}`} />
  ...
  return (
    <div className="relative flex flex-col w-full min-h-screen bg-[#0d1117] overflow-hidden">
      ...
      <footer className="relative z-10 w-full overflow-hidden py-8 md:py-10 lg:py-12 border-t border-white/10">
        <GradientBlur
          className="bottom-0 right-[5%] w-[100px] h-[150px] md:w-[136px] md:h-[223px] rounded-full rotate-[30deg] [background:radial-gradient(50%_50%_at_78%_27%,rgba(0,236,151,0.6)_0%,rgba(61,127,255,0.4)_100%)]"
          opacity="opacity-50"
        />
        <GradientBlur
          className="bottom-[-50px] right-[15%] w-[120px] h-[250px] md:w-[167px] md:h-[392px] rounded-full rotate-[73deg] [background:radial-gradient(50%_50%_at_78%_27%,rgba(61,127,255,0.6)_0%,rgba(0,236,151,0.3)_100%)]"
          opacity="opacity-50"
        />
