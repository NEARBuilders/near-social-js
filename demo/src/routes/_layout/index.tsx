    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl text-white">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            A JavaScript SDK for interacting with the NEAR Social graph database contract
            with helper functions for typical social features.
          </p>
        </div>
        ...
        {accountId ? (
          <div className="mb-12">
            ...
            {isLoading ? (
              ...
              <ProfileCard accountId={accountId} profile={profile ?? null} isOwnProfile />
            )}
          </div>
        ) : (
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-white/60 mb-4">
              High-level social features built on top of the graph.
              Profiles, follows, posts, and likes with visual previews.
            </p>
            <ul className="text-sm text-white/50 space-y-1 mb-4">
